  ...
  return (
    <div className="flex justify-center">
      <div className='text-lg grid grid-cols-2'>
        {resData.map((res) => (
          <div className=" bg-red-100 flex m-4 w-auto p-2 rounded-md cursor-pointer border-2 hover:border-gray-400">
            <img
            ...
            />
            <div className="m-2">
              <h4 key={res.info.id} className="text-sm font-bold">  {res.info.name}  </h4>
              <div className="flex">
